...
const originalData = [
    ...
    { id: 9, platform: 'AVAE', coin: 'XRP', price: 620, principal: 1600, today: 2.40, total: 12.00, apy: '5.6%', duration: '90天' },
    { id: 10, platform: 'LIDO', coin: 'BCH', price: 22.62, principal: 10, today: 28, total: 45.00, apy: '9.6%', duration: '90天' }
];
